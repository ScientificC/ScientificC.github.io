...
(function ($, undefined) {
    ...
    function addUpdated() {
        ...
        var $header = $(".scic_repo_header").text("Recently updated (" + counter + " of total " + updated.length + ") repos shown").addClass("text-center");
    ...
    function addAllRepos() {
        ...
        if (window.location.hash === '#showall') {
            ...
            var $header = $(".scic_repo_header").text("All " + updated.length + " repos shown").addClass("text-center");
    ...
    function addRepos(orgs, repos, page) {
        ...
        var uri = "https://api.github.com/" + orgs.type + "s/" + org + reposcmd +
            "?per_page=1000" +
            "&client_id=d183a572312e44e1a387" +
            "&client_secret=dffdc5647cee7ea958b846bae03a5e4fa6e7e737";
